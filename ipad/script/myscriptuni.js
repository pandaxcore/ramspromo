...
! function(e) {
    ...
    a = jQuery, (i = n.prototype).initialize = function() {
        ...
        var s = new google.maps.LatLng(43.231041, 76.934440);
        new google.maps.Marker({
            position: s,
            map: o,
            icon: "./img/map/pin_forumr.png"
        }),
        a.each([{
            ...
            latitude: 43.244503, /*lamia*/
            longitude: 76.923067,
            pin: "./img/map/pin_lamia.png"
        }, {
            ...
            latitude: 43.236495,/*ortau*/
            longitude: 76.937473,
            pin: "./img/map/pin_ortau.png"
        }],
        (function(e, t) {
            new google.maps.Marker({
    ...
    a = jQuery, l = [
        /*
        ["48,6","48,7","48,9", "49,0", "49,1","49,4", "49,5","53,4", "54,3", "57,9", "58,6","63,0","63,2", "63,3", "63,4", "63,5", "64,1", "64,8"],
        ["70,6", "70,7", "71,0", "75,1", "75,2", "75,8", "76,0", "76,1", "77,9", "92,8", "92,9", "93,4", "94,3", "95,2", "101,7", "102,9", "118,2", "119,0", "126,2", "127,6",],
        */
        ["48,6","58,6","63,0"],
        ["70,6","76,1","92,8","101,7","119,0","127,6",],
        ...
        l[e].forEach((function(e) {
            o += '<div class="room"><div class="stroke jsShowPlan" data-src="./img/room/R-' + e + '.jpg">' + e.replace("1+1", "2 ").replace("2+1", "3 ")/*.replace("3+1", "4 ")*/ + "</div></div>"
